...
### 🔍 **Выводы**
  ...
  Вся последовательность прогнозирования расхода энергии представлена в [Отчете](https://github.com/Licharg/SkillFactory/blob/master/Projects/Project_6/Project_6_Online_customer_segmentation.ipynb) в формате `Jupiter Notebook`. Краткие результаты расчётов представим в виде таблице. Используемые метрики были:
